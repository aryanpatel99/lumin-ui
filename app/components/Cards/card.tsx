...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className={cn(`absolute group h-fit max-w-[85%] my-auto mb-8 dark:bg-muted/70 bg-white border-neutral-200 backdrop-blur-sm dark:bg-linear-to-br dark:from-neutral-900 dark:to-neutral-800 border-2 dark:border-neutral-800 px-5 py-5 rounded-2xl space-y-2 transition-all duration-800 delay-100 ease-out hover:-translate-y-5 dark:hover:border-neutral-700 hover:border-neutral-300`, className)}>
            <div className='flex items-center gap-3'>
                ...
                <p className={cn('text-lg font-semibold transition-all duration-700 ease-in-out', active ? "text-blue-500" : "dark:text-neutral-500 text-neutral-400 group-hover:text-blue-500")}>{title}</p>
            </div>
            <p className='text-md dark:text-neutral-200 text-neutral-900'>{description}</p>
